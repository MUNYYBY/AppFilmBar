import Colors from '@flash/common/styles/Colors';
import {FontFamily, Fonts} from '@flash/common/styles/Fonts';
import {isIOS} from '@flash/common/utils/PlatformUtils';
import {scaleFontSize, scaleSize} from '@flash/common/utils/ScaleSheetUtils';
